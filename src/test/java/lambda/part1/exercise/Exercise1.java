...
public class Exercise1 {
    ...
    public void sortPersonsByLastNameThenFirstNameUsingArraysSortAnonymousComparator() {
        ...
        Comparator<Person> personLastAndFirstNameComparator = new Comparator<Person>() {
            @Override
            public int compare(Person o1, Person o2) {
        ...
        Arrays.sort(persons, personLastAndFirstNameComparator);
    ...
    public void findFirstWithAge30UsingGuavaAnonymousPredicate() {
        ...
        Predicate<Person> person30AgePredicate = new Predicate<Person>() {
            @Override
        ...
        Person person = FluentIterable.from(persons).firstMatch(person30AgePredicate).get();
