...
public class Exercise2 {
    ...
    public void personHasNotEmptyLastNameAndFirstNameUsingGenericPredicates() {
        Predicate<Person> personHasEmptyFirstName = negate(person -> person.getFirstName().isEmpty());
        Predicate<Person> personHasEmptyLastName = negate(person -> person.getLastName().isEmpty());
