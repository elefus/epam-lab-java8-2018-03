...
public class Exercise1 {
    ...
    private static BiFunction<Person,Person,Integer> createExtractorAgeOfPersonWithTheLongestFullName(Function<Person,String> fullNameFunc) {
              return  (person, person2) ->fullNameFunc.apply(person).length()>(fullNameFunc.apply(person2).length())
