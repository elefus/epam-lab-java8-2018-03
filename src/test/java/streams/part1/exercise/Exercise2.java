...
public class Exercise2 {
    ...
    public void findEmployeeWithMaximumDurationAtOnePosition() {
        ...
        Employee expected = employees.stream()
                .max(Comparator.comparingInt(o -> o.getJobHistory().stream()
    ...
    public void calcTotalSalaryWithCoefficientWorkExperience() {
        ...
        Double expected = employees.stream()
                .mapToDouble(employee -> employee.getJobHistory()
                        .get(employee.getJobHistory().size() - 1)
                        .getDuration() > 3 ? 90000 : 75000)
                .sum();
