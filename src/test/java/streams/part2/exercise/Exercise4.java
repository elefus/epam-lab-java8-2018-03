...
public class Exercise4 {
    ...
    /**
     * Выбирает из текста наиболее часто встречающиеся слова. Подсчет слов выполняется без учета их регистра, т.е.
     * "Привет", "привет", "пРиВеТ" - одно и то же слово. Если некоторые слова имеют одинаковую частоту, то в выходном
     * списке они упорядочиваются в лексикографическом порядке.
     *
...
//        throw new UnsupportedOperationException();
        return Stream.of(text.split(" "))
                     ...
                     .collect(Collectors.toMap(Function.identity(),
                                               word -> 1,
                                               (indexFirst, indexSecond) -> indexFirst + indexSecond))
                     .entrySet()
                     .stream()
    ...
    public void test2() {
        ...
        assertEquals(Arrays.asList("consectetur",
                                   "faucibus",
                                   "ipsum",
                                   "lorem",
                                   "adipiscing",
